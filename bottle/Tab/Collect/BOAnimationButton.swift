...
class BOAnimationButton: UIControl {
    ...
    var imageColorOn: UIColor = #colorLiteral(red: 1, green: 0.6745098039, blue: 0.2, alpha: 1) { // UIColor(red: 255/255, green: 172/255, blue: 51/255, alpha: 1.0)
        didSet {
            if (isSelected) {
    ...
    var imageColorOff: UIColor = #colorLiteral(red: 0.9803921569, green: 0.9803921569, blue: 0.9803921569, alpha: 1) { // UIColor(red: 250/255, green: 250/255, blue: 250/255, alpha: 1.0)
        didSet {
            if (!isSelected) {
    ...
    var circleColor: UIColor = #colorLiteral(red: 1, green: 0.6745098039, blue: 0.2, alpha: 1) { // UIColor(red: 255/255, green: 172/255, blue: 51/255, alpha: 1.0)
        didSet {
            circleShapeLayer.fillColor = circleColor.cgColor
        }
    }
    var lineColor: UIColor = #colorLiteral(red: 0.9803921569, green: 0.4705882353, blue: 0.2666666667, alpha: 1) { // UIColor(red: 250/255, green: 120/255, blue: 68/255, alpha: 1.0)
        didSet {
...
private extension BOAnimationButton {
...
@objc extension BOAnimationButton {
    @objc func touchDown(_ sender: BOAnimationButton) {
        layer.opacity = 0.4
    }
    @objc func touchUpInside(_ sender: BOAnimationButton) {
        layer.opacity = 1.0
    }
    @objc func touchDragExit(_ sender: BOAnimationButton) {
        layer.opacity = 1.0
    }
    @objc func touchDragEnter(_ sender: BOAnimationButton) {
        layer.opacity = 0.4
    }
    @objc func touchCancel(_ sender: BOAnimationButton) {
        layer.opacity = 1.0
    }
}
